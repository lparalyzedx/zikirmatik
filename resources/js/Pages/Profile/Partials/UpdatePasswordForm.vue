...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Şifreyi Güncelle</h2>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div>
                <InputLabel for="current_password" value="Geçerli Şifre" />
            ...
            <div class="flex items-center gap-4">
                ...
                <Transition enter-from-class="opacity-0" leave-to-class="opacity-0" class="transition ease-in-out">
                    <p v-if="form.recentlySuccessful" class="text-sm text-gray-600">Kaydedildi.</p>
                </Transition>
            </div>
        </form>
    </section>
